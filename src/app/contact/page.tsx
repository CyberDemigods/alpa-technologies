            ...
            <div className="glass-card p-6">
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-text-muted">
                      {t(lang, 'contact.phoneLabel')}
                    </p>
                    <a
                      href={`tel:${t(lang, "contact.info.phone").replace(
                        /\s/g,
                        ""
                      )}`}
                      className="text-text-primary hover:text-neon transition-colors"
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-text-muted">
                      {t(lang, 'contact.info.addressLabel')}
                    </p>
            ...
            <div className="glass-card p-6">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex justify-between text-text-muted">
                  <span>{t(lang, "contact.hours.weekdays")}</span>
                </li>
                <li className="flex justify-between text-text-muted">
                  <span>{t(lang, "contact.hours.saturday")}</span>
                </li>
                <li className="flex justify-between text-text-muted">
                  <span>{t(lang, "contact.hours.sunday")}</span>
                </li>
              </ul>
            </div>
          </aside>
